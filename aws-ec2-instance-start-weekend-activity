# store EC2 instance state & Snoozing tags in S3.
# This will be our second lamdbda funtion which will start the servers and remove the tags of Snoozing value and it could be "Yes/No/NA/NULL/ " but it doesn't touch anything if server is already in running state.
